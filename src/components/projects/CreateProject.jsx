      ...
      <div className="container">
        ...
        >
          ...
          <div className="input-field">
            ...
            <input type="text" id="regNo" onChange={this.handleChange} required/>
          </div>
          <div className="input-field">
          ...
          {/* <div className="input-field">
            <label htmlFor="regNo">Course</label>
            <input type="regNo" id="regNo" onChange={this.handleChange} required/>
          </div> */}
          {/* <div className="input-field">
            <label htmlFor="course">Course</label>
            <input type="course" id="course" onChange={this.handleChange} required/>
          </div> */}
          <div className="input-field">
